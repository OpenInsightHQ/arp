...
describe('AccessControlService', () => {
  ...
  // ROLE principalId is roles._id (ObjectId), not a role-name string
  ...
  describe('grantPermission', () => {
    describe('validation', () => {
      ...
      test('should throw error for invalid role ID (whitespace only)', async () => {
        ...
        ).rejects.toThrow('Invalid principal ID:');
      });
    ...
    describe('successful grant', () => {
      ...
      test('should grant permission to a role principal', async () => {
        ...
        expect(entry!.principalId).toBeInstanceOf(Types.ObjectId);
