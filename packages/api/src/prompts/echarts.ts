export const ECHARTS_PROMPT = `# ECharts Visualization Generation Guide
...
- For China province maps, use short province names in data (e.g. "浙江", "江苏", "上海", "广东") — NOT full names like "浙江省".
- For world maps, use English country names in data (e.g. "China", "United States", "Russia", "India") to match the world GeoJSON.
- Do NOT set \`visualMap.dimension: 0\` on map charts — it causes incorrect coloring.
