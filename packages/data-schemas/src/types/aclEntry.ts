...
export type AclEntry = {
  /** The type of principal (PrincipalType.USER, PrincipalType.GROUP, PrincipalType.ROLE, PrincipalType.PUBLIC) */
  principalType: PrincipalType;
  /** The ID of the principal (null/absent for PrincipalType.PUBLIC; ObjectId for USER/GROUP/ROLE) */
