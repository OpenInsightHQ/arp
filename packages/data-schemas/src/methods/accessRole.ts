...
export function createAccessRoleMethods(mongoose: typeof import('mongoose')) {
  ...
  async function seedDefaultRoles() {
    ...
    const defaultRoles = [
      ...
      {
        accessRoleId: AccessRoleIds.GALLERY_ARTIFACT_VIEWER,
        name: 'Viewer',
        description: 'Can view the gallery artifact',
        resourceType: ResourceType.GALLERY_ARTIFACT,
        permBits: RoleBits.VIEWER,
      },
      {
        accessRoleId: AccessRoleIds.GALLERY_ARTIFACT_EDITOR,
        name: 'Editor',
        description: 'Can edit the gallery artifact',
        resourceType: ResourceType.GALLERY_ARTIFACT,
        permBits: RoleBits.EDITOR,
      },
      {
        accessRoleId: AccessRoleIds.GALLERY_ARTIFACT_OWNER,
        name: 'Owner',
        description: 'Full control over the gallery artifact',
        resourceType: ResourceType.GALLERY_ARTIFACT,
        permBits: RoleBits.OWNER,
      },
    ];
