...
import { createSystemPromptModel } from './systemPrompt';
...
import { createCredentialModel } from './credential';
...
export function createModels(mongoose: typeof import('mongoose')) {
  return {
    ...
    UserRole: createUserRoleModel(mongoose),
    ...
    SystemPrompt: createSystemPromptModel(mongoose),
    ...
    Credential: createCredentialModel(mongoose),
  };
}

export { createSystemPromptModel };
