...
export type MemoryArtifact = {
  ...
  value?: string;
  tokenCount?: number;
  type: 'update' | 'delete' | 'error' | 'suggestion';
...
export const tConversationSchema = z.object({
  ...
  echartsPrompt: z.boolean().optional(),
  ...
  toolCallVisible: z.boolean().optional(),
...
export const tQueryParamsSchema = tConversationSchema
  .pick({
    ...
    /** Whether tool calls are visible to users, defaults to true */
...
export const agentsSchema = agentsBaseSchema
  .transform((obj) => ({
    ...
    toolCallVisible: obj.toolCallVisible ?? undefined,
  }))
  .catch(() => ({
