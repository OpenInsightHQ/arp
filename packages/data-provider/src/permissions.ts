...
export enum PermissionTypes {
  ...
  /**
   * Type for Gallery Artifact Permissions
   */
...
export const galleryArtifactsPermissionsSchema = z.object({
  [Permissions.USE]: z.boolean().default(true),
  [Permissions.CREATE]: z.boolean().default(true),
  [Permissions.SHARE]: z.boolean().default(false),
  [Permissions.SHARE_PUBLIC]: z.boolean().default(true),
});
export type TGalleryArtifactsPermissions = z.infer<typeof galleryArtifactsPermissionsSchema>;
...
export const permissionsSchema = z.object({
  ...
  [PermissionTypes.GALLERY_ARTIFACTS]: galleryArtifactsPermissionsSchema.optional().default({
