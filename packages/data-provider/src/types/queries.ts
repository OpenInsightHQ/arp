...
export type MinimalConversation = Pick<
  s.TConversation,
  'conversationId' | 'endpoint' | 'title' | 'createdAt' | 'updatedAt' | 'user' | 'messages'
>;
...
export type TSkillDetailTableRow = Record<string, string>;
...
export type TSkillDetail = {
  ...
  skillMd?: string;
  parameters?: TSkillDetailTableRow[];
  outputs?: TSkillDetailTableRow[];
  files?: string[];
  directories?: string[];
  structure?: {
    hasSkillMd: boolean;
...
export type SkillDetailResponse = TSkillDetail;
