...
async function buildEndpointOption(req, res, next) {
  ...
  try {
    ...
    const specificBuilder = buildFunction[endpointType ?? endpoint];
    const useAgentsBuilder = isAgents || !specificBuilder;
    const builder = useAgentsBuilder
    ...
    if (req.body.files && !useAgentsBuilder) {
