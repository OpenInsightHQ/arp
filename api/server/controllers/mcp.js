  ...
  try {
    ...
    for (const serverName of configuredServers) {
      try {
        ...
        const rawServerConfig = await getMCPServersRegistry().getServerConfig(serverName, userId, role);
...
const getMCPServersList = async (req, res) => {
  try {
    ...
    const serverConfigs = await getMCPServersRegistry().getAllServerConfigs(userId, role);
...
const getMCPServerById = async (req, res) => {
  try {
    ...
    const parsedConfig = await getMCPServersRegistry().getServerConfig(serverName, userId, role);
