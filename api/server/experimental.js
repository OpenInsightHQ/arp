...
if (cluster.isMaster) {
  ...
  const startServer = async () => {
    ...
    app.use('/arp', staticCache(appConfig.paths.fonts));
    app.use('/arp', staticCache(appConfig.paths.assets));
    ...
    app.use('/arp/api/plugins', routes.plugins);
    ...
    /** SPA fallback - serve index.html for all unmatched routes under /arp */
    app.use('/arp', (req, res) => {
      res.set({
