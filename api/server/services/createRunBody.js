 ...
 * @param {string} [options.endpointOption.artifactsPrompt] - Artifacts prompt instructions.
 * @param {string} [options.endpointOption.visualizationPrompt] - Visualization prompt instructions.
...
const createRunBody = ({
  ...
  if (
    typeof endpointOption?.visualizationPrompt === 'string' &&
    endpointOption.visualizationPrompt
  ) {
    systemInstructions += `\n${endpointOption.visualizationPrompt}`;
  }
