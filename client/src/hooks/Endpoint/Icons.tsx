...
const OpenInsightIcon = ({ className = '', size }: { className?: string; size?: number }) => {
  return (
    <img
...
const AgentAvatar = ({ className = '', avatar = '', agentName, size }: AgentIconMapProps) => {
  ...
  // Use OpenInsight logo as default agent icon
  return <OpenInsightIcon className={className} size={size} />;
};
