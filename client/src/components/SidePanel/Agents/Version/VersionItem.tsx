  ...
  return (
    <div className="rounded-md border border-border-light p-3">
      <div className="flex items-center justify-between font-medium">
        ...
        {isActive && (
          <span className="rounded-full border border-purple-500 bg-purple-500/20 px-2 py-0.5 text-xs font-medium text-purple-600 dark:border-purple-400 dark:bg-purple-500/20 dark:text-purple-300">
