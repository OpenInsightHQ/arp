    ...
    <>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          onClick={saveAction}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-[#7948ea] px-4 py-2 font-semibold text-white hover:bg-[#6b3bd9] focus:border-[#7948ea] focus:outline-none focus:ring-0 disabled:bg-[#9b6cf0]"
          type="button"
        >
          {getButtonContent()}
        </button>
