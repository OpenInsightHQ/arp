...
type FavoriteItemProps = {
  ...
  newConversation?: (params: {
    ...
    preset?: Partial<import('librechat-data-provider').TPreset>;
  }) => void;
};
...
export default function FavoriteItem({
  ...
  const handleSelect = () => {
    if (type === 'agent') {
      ...
      // Create new conversation instead of switching endpoint
      if (newConversation) {
        newConversation({
          template: {
  ...
  return (
    <div
      ...
      className={cn(
        'group relative flex w-full cursor-pointer items-center justify-between rounded-lg px-3 py-2 text-[13px] text-text-primary outline-none hover:bg-surface-active-alt focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-black dark:focus-visible:ring-white',
