...
import { MyPromptsPanel } from '~/components/Prompts';
import { useLocalize } from '~/hooks';
import type { TDialogProps } from '~/common';
import { cn } from '~/utils';

export default function PromptModal({ open, onOpenChange }: TDialogProps) {
          ...
          <div className={cn('fixed inset-0 flex w-screen items-center justify-center p-4')}>
            ...
            >
              ...
              <div className="max-h-[calc(85vh-80px)] overflow-auto p-4 pt-0">
                <MyPromptsPanel onClose={() => onOpenChange(false)} />
              </div>
            </DialogPanel>
          </div>
        </TransitionChild>
