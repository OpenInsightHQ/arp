      ...
      return (
        <>
          <div
            data-testid="nav"
            className={cn(
              'nav fixed left-0 top-0 z-[110] h-full bg-gradient-to-r from-white via-white to-[#f0f0f3] dark:from-[#1e1e1e] dark:to-[#141414]',
              navVisible && 'active',
            )}
            style={{
              width: sidebarWidth,
    ...
    return (
      ...
      >
        <motion.div
          data-testid="nav"
          className={cn(
            'nav h-full bg-gradient-to-r from-white via-white to-[#f0f0f3] dark:from-[#1e1e1e] dark:to-[#141414]',
            navVisible && 'active',
          )}
