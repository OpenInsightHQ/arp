...
import ConversationWatermark from './ConversationWatermark';
...
function MessagesViewContent({
  ...
  const { activeId, navigateTo } = useChatNavigation({
    scrollableRef,
  });
    ...
    <>
      <div className="relative flex-1 overflow-hidden overflow-y-auto">
        ...
        <div className="relative h-full">
          ...
          <ChatNavigation
            messagesTree={_messagesTree ?? null}
            parentMessageId={conversationId ?? null}
            activeId={activeId}
